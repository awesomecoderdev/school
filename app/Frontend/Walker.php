 ...
 * @access   private
 */
class SchoolPrimaryMobileMenu extends \Walker_Nav_Menu
{
	...
	public function start_lvl(&$output, $depth = 0, $args = array())
	{
		...
		// add contents
		ob_start();
		require SCHOOL_THEME_PATH . "/template/navigation/mobile/start_lvl.php";
		$output .= ob_get_contents();
		ob_end_clean();
	}
	...
	public function end_lvl(&$output, $depth = 0, $args = array())
	{
		...
		// add contents
		ob_start();
		require SCHOOL_THEME_PATH . "/template/navigation/mobile/end_lvl.php";
		$output .= ob_get_contents();
		ob_end_clean();
	...
	public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
	{
		...
		// add contents
		ob_start();
		require SCHOOL_THEME_PATH . "/template/navigation/mobile/start_el.php";
		$item_output .= ob_get_contents();
		ob_end_clean();
 ...
 * @access   private
 */
class SchoolPrimaryMobileMenus extends \Walker_Nav_Menu
{
