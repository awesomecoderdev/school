...
use AwesomeCoder\School\Wp\AdminPage;
use AwesomeCoder\School\Wp\Asset;
use AwesomeCoder\School\Wp\Menu;
use AwesomeCoder\School\Wp\SubMenu;
...
class Backend
{
	...
	public function enqueue_styles($hook)
	{
		...
		Asset::style($this->template_name, "backend/css/school-admin.css", $this->version, [], 'all');
	...
	public function enqueue_scripts()
	{
		...
		Asset::script($this->template_name, "assets/backend/js/school-admin.js", $this->version, ['jquery'], false, true);
	 ...
	 * @since    1.0.0
	 */
	public function school_after_setup_theme()
	{
		/**
		 ...
		 * class.
		 */
		require_once SCHOOL_THEME_PATH . "includes/Hooks/Theme.php";
	}
	 ...
	 * @since    1.0.0
	 */
	public function school_admin_menu()
	{
		...
		$menu = new AdminPage(__("School", 'school'), fn () => school_resource());
		Menu::register(new Menu($menu, 'school', __("School", 'school'), "manage_options", $icon, 50));
