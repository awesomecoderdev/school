...
use AwesomeCoder\School\Loader;
use AwesomeCoder\School\Backend;
use AwesomeCoder\School\Wp\Ajax;
use AwesomeCoder\School\Frontend;
...
class School
{
	...
	{
		if (defined('SCHOOL_THEME_VERSION')) {
			$this->version = SCHOOL_THEME_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->template_name = 'school';
	...
	private function load_dependencies()
	{
		 ...
		 * core template.
		 */
		require_once SCHOOL_THEME_PATH . 'includes/Loader/Loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the template.
		 */
		require_once SCHOOL_THEME_PATH . 'includes/Localization/I18n.php';

		/**
		 * The class responsible for defining hooks functionality
		 * of the template.
		 */
		require_once SCHOOL_THEME_PATH . 'includes/Hooks/Activator.php';

		/**
		 * The class responsible for defining hooks functionality
		 * of the template.
		 */
		require_once SCHOOL_THEME_PATH . 'includes/Hooks/Deactivator.php';

		/**
		 * The class responsible for defining hooks functionality
		 * of the template.
		 */
		// require_once SCHOOL_THEME_PATH . 'includes/Hooks/Woocommerce.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once SCHOOL_THEME_PATH . 'app/Backend/Backend.php';
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action('admin_menu', $template_admin, 'school_admin_menu');
		/** after setup theme */
		$this->loader->add_action('after_setup_theme', $template_admin, 'school_after_setup_theme');
	}
	...
	private function define_ajax_hooks()
	{
		$template_admin = new Backend($this->get_template_name(), $this->get_version());
		$template_public = new Frontend($this->get_template_name(), $this->get_version());
		$template_both = new AjaxController($this->get_template_name(), $this->get_version());
